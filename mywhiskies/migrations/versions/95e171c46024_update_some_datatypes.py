...
def upgrade():
    ...
    with op.batch_alter_table('bottle', schema=None) as batch_op:
        batch_op.alter_column('type',
               existing_type=mysql.ENUM('american_whiskey', 'bourbon', 'canadian_whiskey', 'irish_whiskey', 'rye', 'scotch', 'world_whiskey', 'other'),
               nullable=False)
        batch_op.alter_column('abv',
        ...
        batch_op.alter_column('cost',
               ...
               existing_nullable=True)
        batch_op.alter_column('image_count',
